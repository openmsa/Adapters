...
//require_once load_once('paloalto_generic', 'common.php');
require_once load_once('paloalto_generic', 'paloalto_generic_apply_conf.php');
//require_once load_once('paloalto_generic', 'paloalto_generic_apply_restore_conf.php');


require_once "$db_objects";
class paloalto_generic_configuration
{
  ...
  {
    $ret = paloalto_generic_apply_restore_conf($configuration);
    return $ret;
  }
  ...
  function update_conf()
  {
    ...
    {
      #$ret = paloalto_generic_apply_conf($generated_configuration);
