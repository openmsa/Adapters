...
require_once load_once('dell_redfish', 'dell_redfish_apply_conf.php');
//require_once load_once('dell_redfish', 'dell_redfish_apply_command_delete.php');
...
{
    $ret = dell_redfish_connect($login, $passwd);
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = dell_redfish_apply_conf($configuration, false);
...
// 	$ret = dell_redfish_apply_command_delete($configuration, false);
