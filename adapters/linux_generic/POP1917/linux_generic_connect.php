...
function linux_generic_synchro_prompt()
{
  ...
  //HGU $msg = 'UBISyncro' . mt_rand(10000, 99999);
  //HGU $prompt = $sms_sd_ctx->getPrompt();
  //HGU sendexpectone(__FILE__ . ':' . __LINE__, $sms_sd_ctx, "echo -n {$msg}", "{$msg}{$prompt}");
}
...
class LinuxsshKeyConnection extends SshKeyConnection
{
  public function do_store_prompt()
  {
    ...
    //HGU $this->sendCmd(__FILE__ . ':' . __LINE__, "stty -echo");
    //HGU $this->sendCmd(__FILE__ . ':' . __LINE__, "stty -onlcr ocrnl -echoctl -echoe -opost rows 0 columns 0 line 0");
    //$this->sendCmd(__FILE__ . ':' . __LINE__, "RTRV-PATCH:PolatisOXC::123:;");
    $tab[0] = '#';
    $tab[1] = '$';
    $tab[2] = '>';
    $tab[3] = '%';
    ...
    //HGU sendexpectone(__FILE__ . ':' . __LINE__, $this, 'echo -n UBISynchroForPrompt', 'UBISynchroForPrompt');
    //$this->sendCmd(__FILE__ . ':' . __LINE__, "RTRV-PATCH:PolatisOXC::123:;");
    ...
    //HGU $msg = 'UBISyncro' . mt_rand(10000, 99999);
    //HGU $prompt = $this->prompt;
    //HGUsendexpectone(__FILE__ . ':' . __LINE__, $this, "echo -n {$msg}", "{$msg}{$prompt}");
...
class LinuxGenericsshConnection extends SshConnection
{
  public function do_store_prompt()
  {
    ...
    //HGU $msg = 'UBISyncro' . mt_rand(10000, 99999);
    //HGU $prompt = $this->prompt;
    //HGU sendexpectone(__FILE__ . ':' . __LINE__, $this, "echo -n {$msg}", "{$msg}{$prompt}");
