...
require_once load_once('nokia_vsd', 'nokia_vsd_apply_conf.php');
...
{
  $ret = nokia_vsd_connect($login, $passwd);
  return $ret;
}
...
function sd_apply_conf($configuration, $need_sd_connection)
{
  ...
  $ret = nokia_vsd_apply_conf($configuration);
