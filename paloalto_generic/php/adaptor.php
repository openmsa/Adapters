...
//require_once load_once('paloalto_generic', 'paloalto_generic_apply_command_delete.php');
...
{
	$ret = paloalto_generic_connect($login, $passwd);
...
{
	$ret = paloalto_generic_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = paloalto_generic_apply_conf($configuration, false);
...
// 	$ret = paloalto_generic_apply_command_delete($configuration, false);
