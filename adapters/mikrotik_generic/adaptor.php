...
//require_once load_once('mikrotik_generic', 'mikrotik_generic_apply_command_delete.php');
...
{
	$ret = mikrotik_generic_connect($login, $passwd);
...
{
	$ret = mikrotik_generic_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = mikrotik_generic_apply_conf($configuration);
...
function sd_apply_command_delete($configuration, $need_sd_connection = false)
{
	...
	$ret = mikrotik_generic_apply_command_delete($configuration, false);
