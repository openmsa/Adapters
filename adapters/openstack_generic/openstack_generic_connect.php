...
class OpenStackGenericRESTConnection extends GenericConnection
{
  private $key;
  ...
  public function do_connect()
  {
    ...
    $tenant_id = $sd->SD_CONFIGVAR_list['ADMIN_TENANT_ID']->VAR_VALUE;
  ...
  public function send($origin, $cmd)
  {
    ...
    if ($action[1] == "")
    {
      ...
      $action[2] = 'https://' . $this->sd_ip_config  . $action[2];
    }
    else
    {
...
function openstack_connect($sd_ip_addr = null, $login = null, $passwd = null, $port_to_use = null)
{
  ...
  $sms_sd_ctx = new OpenStackGenericRESTConnection($sd_ip_addr, $login, $passwd, $port_to_use);
  return SMS_OK;
}
