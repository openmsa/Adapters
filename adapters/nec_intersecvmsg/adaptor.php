...
//require_once load_once('nec_intersecvmsg', 'nec_intersecvmsg_apply_command_delete.php');
...
{
	$ret = nec_intersecvmsg_connect(null, $login, $passwd, $adminpasswd, '18022');
...
{
	$ret = nec_intersecvmsg_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = nec_intersecvmsg_apply_conf($configuration);
...
function sd_apply_command_delete($configuration, $need_sd_connection = false)
{
	...
	$ret = nec_intersecvmsg_apply_command_delete($configuration, false);
