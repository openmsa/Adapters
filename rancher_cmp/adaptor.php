...
require_once load_once('rancher_cmp', 'rancher_cmp_apply_conf.php');
...
{
  $ret = rancher_cmp_connect($login, $passwd);
  return $ret;
}
...
{  
  ...
  $ret = rancher_cmp_apply_conf($configuration);
