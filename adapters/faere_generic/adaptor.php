...
{
  return faere_generic_connect($login, $passwd);
}
...
{
  return  faere_generic_disconnect();
}
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
  ...
  $ret = faere_generic_apply_conf($configuration, false);
...
function sd_save_conf()
{
  ...
  $conf = new faere_generic_configuration($sdid);
