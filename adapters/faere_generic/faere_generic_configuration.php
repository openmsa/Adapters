<?php
/*
 * Version: $Id: faere_generic_configuration.php 58927 2012-06-11 15:15:18Z abr $
 * Created: Feb 12, 2009
 */
...
require_once load_once('faere_generic', 'faere_generic_apply_conf.php');
require_once "$db_objects";
class faere_generic_configuration
{
  ...
  function get_running_conf()
  {
    ...
    // Run the CLI Cmd
	$this->running_conf = sendexpectone(__FILE__ . ':' . __LINE__, $sms_sd_ctx, "cat /etc/dreddA/tdsconfig.json");
	$prompt = $sms_sd_ctx->getPrompt();
	echo("NEWPROMPT $prompt");
	$this->running_conf = str_replace($prompt, '', $this->running_conf);
  ...
  function update_conf()
  {
    ...
    {
      $ret = faere_generic_apply_conf($generated_configuration, $this->is_ztd);
    }
    return $ret;
  }
