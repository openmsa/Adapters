...
require_once load_once('hp5900', 'hp5900_restore_configuration.php');
...
try
{
  ...
  $conf = new hp5900_restore_configuration($sdid);
  ...
  require_once load_once('hp5900', 'do_backup_conf.php');
