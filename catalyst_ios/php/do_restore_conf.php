...
require_once load_once('catalyst_ios', 'catalyst_ios_restore_configuration.php');
...
try
{
  ...
  $conf = new catalyst_ios_restore_configuration($sdid);
  ...
  require_once load_once('catalyst_ios', 'do_backup_conf.php');
