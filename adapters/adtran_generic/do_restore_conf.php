...
require_once load_once('adtran_generic', 'adtran_generic_restore_configuration.php');
...
try
{
  ...
  $conf = new adtran_generic_restore_configuration($sdid);
  ...
  sleep(15);
  require_once load_once('adtran_generic', 'do_backup_conf.php');
