...
require_once load_once('fortinet_fortimanager', 'fortinet_fortimanager_apply_conf.php');
//require_once load_once('fortinet_fortimanager', 'fortinet_fortimanager_apply_command_delete.php');
...
{
    $ret = fortinet_fortimanager_connect($login, $passwd);
...
{
    $ret = fortinet_fortimanager_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = fortinet_fortimanager_apply_conf($configuration, false);
...
// 	$ret = fortinet_fortimanager_apply_command_delete($configuration, false);
