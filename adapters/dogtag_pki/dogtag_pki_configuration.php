<?php
/*
 * Version: $Id: dogtag_pki_configuration.php 58927 2012-06-11 15:15:18Z abr $
 * Created: Feb 12, 2009
 */
...
require_once load_once('dogtag_pki', 'adaptor.php');
require_once load_once('dogtag_pki', 'dogtag_pki_apply_conf.php');
require_once "$db_objects";
class dogtag_pki_configuration
{
  ...
  function update_conf()
  {
    ...
    {
      $ret = dogtag_pki_apply_conf($generated_configuration, $this->is_ztd);
    }
    return $ret;
  }
