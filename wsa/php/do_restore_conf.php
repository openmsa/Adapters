...
require_once load_once('wsa', 'common.php');
...
try
{
    ...
    require_once load_once('wsa', 'do_backup_conf.php');
...
{
    wsa_disconnect();
    sms_set_update_status($sms_csp, $sdid, $e->getCode(), 'RESTORE', 'FAILED', "Failed restoring revision $revision_id: " . $e->getMessage());
    sms_sd_unlock($sms_csp, $sms_sd_info);
}
