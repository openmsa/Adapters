...
class DeviceConnection extends GenericConnection {
	...
	public function send($origin, $rest_cmd) {
		...
		// Add AWS SigV4 headers manually
		$headers_new[] = 'Authorization: AWS4-HMAC-SHA256 Credential=' . $auth;
		$headers_new[] = 'X-Amz-Date: ' . gmdate('Ymd\THis\Z');
		$headers_new[] = 'X-Amz-Security-Token: ' . $aws_sigv4;
