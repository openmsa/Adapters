...
//require_once load_once('versa_director', 'versa_director_apply_command_delete.php');
...
{
	$ret = versa_director_connect($login, $passwd);
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = versa_director_apply_conf($configuration, false);
