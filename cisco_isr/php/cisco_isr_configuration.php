<?php
/*
 * Version: $Id: cisco_isr_configuration.php 58927 2012-06-11 15:15:18Z abr $
* Created: Feb 12, 2009
*/
...
class cisco_isr_configuration
{
  ...
  function update_conf($flag = false)
  {
    ...
    {
      $ret = cisco_isr_apply_conf($generated_configuration,$flag);
    }
    return $ret;
  }
