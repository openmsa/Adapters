...
require_once load_once('intel_redfish', 'intel_redfish_apply_conf.php');
//require_once load_once('intel_redfish', 'intel_redfish_apply_command_delete.php');
...
{
    $ret = intel_redfish_connect($login, $passwd);
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = intel_redfish_apply_conf($configuration, false);
...
// 	$ret = intel_redfish_apply_command_delete($configuration, false);
