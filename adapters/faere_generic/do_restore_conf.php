...
require_once load_once('faere_generic', 'faere_generic_restore_configuration.php');
...
try
{
  ...
  $conf = new faere_generic_restore_configuration($sdid);
  ...
  require_once load_once('faere_generic', 'do_backup_conf.php');
