...
require_once load_once('opendaylight', 'adaptor.php');
//require_once load_once('openstack', 'common.php');
require_once load_once('opendaylight', 'opendaylight_apply_conf.php');
//require_once load_once('openstack', 'openstack_apply_restore_conf.php');


require_once "$db_objects";
class opendaylight_configuration
{
  ...
  {
    $ret = opendaylight_apply_restore_conf($configuration);
    return $ret;
  }
  ...
  function update_conf()
  {
    ...
    {
      $ret = opendaylight_apply_conf($generated_configuration);
    }
