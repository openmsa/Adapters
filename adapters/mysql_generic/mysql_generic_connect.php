...
function mysql_generic_connect($sd_ip_addr = null, $login = null, $passwd = null, $adminpasswd = null, $port_to_use = null)
{
  global $sms_sd_ctx;
  try
  {
    $sms_sd_ctx = new MysqlBashConnection($sd_ip_addr, $login, $passwd, $adminpasswd, $port_to_use);
...
// Disconnect
// return false if error, true if ok
function mysql_generic_disconnect()
{
  $sms_sd_ctx = null;
  return SMS_OK;
}
...
class MysqlBashConnection extends BashConnection
{
  public function do_store_prompt()
  {
    global $sendexpect_result;
