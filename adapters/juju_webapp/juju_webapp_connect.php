...
class Juju_connection extends GenericConnection
{
		public $rest_json;
...
echo "auth mode is oauth\n";
				...
				echo  "juju_webapp_connect: setting SIGNIN_REQ_PATH to: {$sms_sd_ctx->sign_in_req_path}\n";
			}
			...
			echo  "juju_webapp_connect: setting HTTP protocol to: {$this->protocol}\n";
...
function juju_webapp_connect($sd_ip_addr = null, $login = null, $passwd = null, $port_to_use = null)
{
        global $sms_sd_ctx;

        $sms_sd_ctx = new Juju_connection($sd_ip_addr, $login, $passwd, $port_to_use);
        return SMS_OK;
}

// ------------------------------------------------------------------------------------------------
// Disconnect
function juju_webapp_disconnect()
{
        global $sms_sd_ctx;
        $sms_sd_ctx = null;
        return SMS_OK;
