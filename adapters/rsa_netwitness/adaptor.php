...
require_once load_once('rsa_netwitness', 'rsa_netwitness_apply_conf.php');
//require_once load_once('rsa_netwitness', 'rsa_netwitness_apply_command_delete.php');
...
{
    $ret = rsa_netwitness_connect($login, $passwd);
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = rsa_netwitness_apply_conf($configuration, false);
...
// 	$ret = rsa_netwitness_apply_command_delete($configuration, false);
