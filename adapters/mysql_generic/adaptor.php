...
{
  return mysql_generic_connect($login, $passwd);
}
...
{
  return  mysql_generic_disconnect();
}
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
  ...
  $ret = mysql_generic_apply_conf($configuration, false);
...
function sd_save_conf()
{
  ...
  $conf = new mysql_generic_configuration($sdid);
