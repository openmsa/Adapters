...
class NecIntersecvmsgsshConnection extends SshConnection
{
  ...
  public function do_connect() {
    nec_intersecvmsg_dbg_print(NEC_DEBUG, __FILE__ . ':' . __LINE__, 'START nec_intersecvmsg_connect:do_connect');
    ...
    nec_intersecvmsg_dbg_print(NEC_DEBUG, __FILE__ . ':' . __LINE__, 'END nec_intersecvmsg_connect:do_connect');
...
function nec_intersecvmsg_connect($sd_ip_addr = null, $login = null, $passwd = null, $admin_password = null, $port_to_use = null)
{
	global $sms_sd_ctx;
	$sms_sd_ctx = new NecIntersecvmsgsshConnection($sd_ip_addr, $login, $passwd, $admin_password, $port_to_use);
...
// ------------------------------------------------------------------------------------------------
// Disconnect
function nec_intersecvmsg_disconnect()
{
	global $sms_sd_ctx;
	$sms_sd_ctx = null;
	return SMS_OK;
