...
require_once load_once('citrix_netscalar', 'citrix_netscalar_apply_conf.php');
...
{
  $ret = citrix_netscalar_connect($login, $passwd);
...
{
  $ret = citrix_netscalar_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
  ...
  $ret = citrix_netscalar_apply_conf($configuration, false);
