...
require_once load_once('nec_ipasolink', 'apply_errors.php');
require_once load_once('nec_ipasolink', 'nec_ipasolink_configuration.php');
require_once load_once('nec_ipasolink', 'nec_ipasolink_connect.php');

require_once "$db_objects";

define('DELAY', 200000);
function nec_ipasolink_apply_conf($configuration, $is_ztd)
{
  global $sdid;
  global $sms_sd_ctx;
  global $sms_sd_info;
  ...
  $ret = sendexpect(__FILE__ . ':' . __LINE__, $sms_sd_ctx, "configuration", "(config)#");
  ...
  $ret = sendexpect(__FILE__ . ':' . __LINE__, $sms_sd_ctx, "exit", "#");
  return $ret;
}
