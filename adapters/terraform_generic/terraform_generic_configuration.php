<?php
/*
 * Version: $Id: terraform_generic_configuration.php 58927 2012-06-11 15:15:18Z abr $
 * Created: Feb 12, 2009
 */
...
require_once load_once('terraform_generic', 'adaptor.php');
require_once load_once('terraform_generic', 'terraform_generic_apply_conf.php');
require_once "$db_objects";
class terraform_generic_configuration
{
  ...
  function update_conf()
  {
    ...
    {
      $ret = terraform_generic_apply_conf($generated_configuration, $this->is_ztd);
    }
    return $ret;
  }
