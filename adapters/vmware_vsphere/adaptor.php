...
require_once load_once('vmware_vsphere', 'vmware_vsphere_apply_conf.php');
...
{
  $ret = vmware_vsphere_connect($login, $passwd);
  return $ret;
}
...
function sd_apply_conf($configuration, $need_sd_connection)
{
  ...
  $ret = vmware_vsphere_apply_conf($configuration);
