...
require_once load_once('terraform_generic', 'terraform_generic_connect.php' , 'common.php');
...
if ($ret !== SMS_OK)
{
  sms_log_error(__FILE__.':'.__LINE__.": terraform_generic_connect() failed\n");
  sms_send_user_error($sms_csp, $sdid, "", $ret);
  return $ret;
}

$on_error_fct = 'terraform_generic_disconnect';
