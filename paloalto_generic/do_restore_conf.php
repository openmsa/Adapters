...
require_once load_once('paloalto_generic', 'paloalto_generic_restore_configuration.php');
...
try
{
  ...
  require_once load_once('paloalto_generic', 'do_backup_conf.php');
