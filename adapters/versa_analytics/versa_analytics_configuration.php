...
//require_once load_once('versa_analytics', 'common.php');
require_once load_once('versa_analytics', 'versa_analytics_apply_conf.php');
//require_once load_once('versa_analytics', 'versa_analytics_apply_restore_conf.php');


require_once "$db_objects";
class versa_analytics_configuration
{
  ...
  {
    $ret = versa_analytics_apply_restore_conf($configuration);
    return $ret;
  }
  ...
  function update_conf()
  {
    ...
    {
      $ret = versa_analytics_apply_conf($generated_configuration);
    }
