...
{
  return terraform_generic_connect($login, $passwd);
}
...
{
  return  terraform_generic_disconnect();
}
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
  ...
  {
    terraform_generic_synchro_prompt();
  }
  if ($ret != SMS_OK)
  {
  ...
  $ret = terraform_generic_apply_conf($configuration, false);
