...
function fujitsu_ipcom_connect_port($ts_ip, $ts_port, $adminpasswd = null)
{
  global $sms_sd_ctx;
...
// Disconnect
// return false if error, true if ok
function fujitsu_ipcom_disconnect_port()
{
  global $sms_sd_ctx;
  $sms_sd_ctx = null;
  return SMS_OK;
...
class CiscoIsrPortConsoleConnection extends PortConsoleConnection
{
	...
	public function do_store_prompt() {
		$buffer = sendexpectone(__FILE__.':'.__LINE__, $this, 'configuration', '(config)#');
