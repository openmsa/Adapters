...
require_once load_once('hp2530', 'hp2530_restore_configuration.php');
...
try
{
  ...
  $conf = new hp2530_restore_configuration($sdid);
  ...
  require_once load_once('hp2530', 'do_backup_conf.php');
