...
require_once load_once('redfish_generic', 'redfish_generic_apply_conf.php');
//require_once load_once('redfish_generic', 'redfish_generic_apply_command_delete.php');
...
{
    $ret = redfish_generic_connect($login, $passwd);
...
{
    $ret = redfish_generic_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = redfish_generic_apply_conf($configuration, false);
...
// 	$ret = redfish_generic_apply_command_delete($configuration, false);
