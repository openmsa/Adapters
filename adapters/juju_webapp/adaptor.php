...
require_once load_once('juju_webapp', 'juju_webapp_apply_conf.php');
...
{
	return juju_webapp_connect($login, $passwd);
}
...
function sd_apply_conf($configuration, $need_sd_connection)
{
	...
	$ret = juju_webapp_apply_conf($configuration);
