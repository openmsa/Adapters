...
require_once load_once('nec_ix', 'provisioning_stages.php');
...
{
  sms_send_user_error($sms_csp, $sdid, "addr=$ipaddr login=$login pass=$passwd adminpasswd=$adminpasswd port=$port", ERR_VERB_BAD_PARAM);
  return SMS_OK;
}
