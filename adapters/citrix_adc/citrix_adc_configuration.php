...
require_once load_once('citrix_adc', 'common.php');
require_once load_once('citrix_adc', 'adaptor.php');
require_once load_once('citrix_adc', 'citrix_adc_apply_conf.php');
require_once load_once('citrix_adc', 'citrix_adc_apply_restore_conf.php');

require_once "$db_objects";
class citrix_netscalar_configuration
{
  ...
  function get_running_conf()
  {
    ...
    // Run the CLI Cmd
    $SMS_OUTPUT_BUF .= sendexpectone(__FILE__ . ':' . __LINE__, $sms_sd_ctx, "show ns runningConfig");
  ...
  {
    $ret = citrix_netscalar_apply_restore_conf($configuration);
    return $ret;
  }
  ...
  function update_conf()
  {
    ...
    {
      $ret = citrix_netscalar_apply_conf($generated_configuration);
    }
