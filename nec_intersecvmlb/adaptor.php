...
require_once load_once('nec_intersecvmlb', 'nec_intersecvmlb_apply_conf.php');
//require_once load_once('nec_intersecvmlb', 'nec_intersecvmlb_apply_command_delete.php');
...
{
	$ret = nec_intersecvmlb_connect($login, $passwd);
...
{
	$ret = nec_intersecvmlb_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = nec_intersecvmlb_apply_conf($configuration);
...
function sd_apply_command_delete($configuration, $need_sd_connection = false)
{
	...
	$ret = nec_intersecvmlb_apply_command_delete($configuration, false);
