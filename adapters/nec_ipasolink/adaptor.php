...
require_once load_once('nec_ipasolink', 'nec_ipasolink_apply_conf.php');
...
{
  return nec_ipasolink_connect($login, $passwd);
}
...
{
  return  nec_ipasolink_disconnect();
}
