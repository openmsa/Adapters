...
function adtran_generic_connect($sd_ip_addr = null, $login = null, $passwd = null, $adminpasswd = null, $port_to_use = null)
{
  global $sms_sd_ctx;


  echo "===============   adtran_generic_connect($sd_ip_addr = null, $login = null, $passwd = null, $adminpasswd = null, $port_to_use = null) \n";
...
// Disconnect
// return false if error, true if ok
function adtran_generic_disconnect()
{
  global $sms_sd_ctx;
