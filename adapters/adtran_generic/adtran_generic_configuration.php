<?php
/*
 * Version: $Id: adtran_generic_configuration.php 58927 2012-06-11 15:15:18Z abr $
* Created: Feb 12, 2009
*/
...
require_once load_once('adtran_generic', 'adaptor.php');
require_once load_once('adtran_generic', 'adtran_generic_apply_conf.php');
require_once "$db_objects";

class adtran_generic_configuration
{
  ...
  function get_running_conf()
  {
    ...
    if (!empty($running_conf))
    {
      ...
      $running_conf = remove_end_of_line_starting_with($running_conf, 'username adtran_generic password 7');
  ...
  function update_conf()
  {
    ...
    {
      $ret = adtran_generic_apply_conf($generated_configuration);
    }
    return $ret;
  }
