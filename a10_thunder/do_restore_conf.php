...
require_once load_once('a10_thunder', 'a10_thunder_restore_configuration.php');
...
try
{
  ...
  $conf = new a10_thunder_restore_configuration($sdid);
  ...
  require_once load_once('a10_thunder', 'do_backup_conf.php');
