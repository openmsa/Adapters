<?php
/*
 * 	Version: 0.1: catalyst_ios_connect_port.php
*  	Created: Jun 7, 2012
...
function catalyst_ios_connect_port($ts_ip, $ts_port, $adminpasswd = null)
{
  global $sms_sd_ctx;
  
  try{
  $sms_sd_ctx = new CatalystIosPortConsoleConnection($ts_ip, null, null, $adminpasswd, $ts_port);
...
// Disconnect
// return false if error, true if ok
function catalyst_ios_disconnect_port()
{
  global $sms_sd_ctx;
  $sms_sd_ctx = null;
  return SMS_OK;
...
class CatalystIosPortConsoleConnection extends PortConsoleConnection
{
