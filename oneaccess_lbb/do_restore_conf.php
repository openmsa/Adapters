...
require_once load_once('oneaccess_lbb', 'oneaccess_lbb_restore_configuration.php');
...
try
{
  ...
  if ($ret != SMS_OK)
  {
	...
	$conf = new oneaccess_lbb_restore_configuration($sdid);
  ...
  require_once load_once('oneaccess_lbb', 'do_backup_conf.php');
