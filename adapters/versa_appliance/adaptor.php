...
//require_once load_once('versa_appliance', 'versa_appliance_apply_command_delete.php');
...
{
	$ret = versa_appliance_connect($login, $passwd);
...
{
	$ret = versa_appliance_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = versa_appliance_apply_conf($configuration, false);
