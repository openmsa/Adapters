...
require_once load_once('nec_ix', 'nec_ix_restore_configuration.php');
...
try
{
  ...
  $conf = new nec_ix_restore_configuration($sdid);
  ...
  require_once load_once('nec_ix', 'do_backup_conf.php');
