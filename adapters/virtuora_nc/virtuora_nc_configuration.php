...
//require_once load_once('virtuora_nc', 'common.php');
require_once load_once('virtuora_nc', 'virtuora_nc_apply_conf.php');
//require_once load_once('virtuora_nc', 'virtuora_nc_apply_restore_conf.php');


require_once "$db_objects";
class virtuora_nc_configuration
{
...
//     return $this->running_conf;
  ...
  {
    $ret = virtuora_nc_apply_restore_conf($configuration);
    return $ret;
  }
  ...
  function update_conf()
  {
    ...
    {
      #$ret = virtuora_nc_apply_conf($generated_configuration);
