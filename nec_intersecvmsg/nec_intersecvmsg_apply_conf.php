<?php
/*
 * Version: $Id: nec_intersecvmsg_apply_conf.php 112 2016-12-06 15:36:32Z domeki $
* Created: May 13, 2011
...
require_once load_once('nec_intersecvmsg', 'apply_errors.php');
...
function nec_intersecvmsg_apply_conf(&$configuration)
{
  global $sdid;
  global $sms_sd_ctx;
  global $sms_sd_info;
