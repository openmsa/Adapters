...
//require_once load_once('fortinet_generic', 'fortinet_generic_apply_command_delete.php');
...
{
	$ret = fortinet_generic_connect($login, $passwd);
...
{
	$ret = fortinet_generic_disconnect();
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = fortinet_generic_apply_conf($configuration);
...
function sd_apply_command_delete($configuration, $need_sd_connection = false)
{
	...
	$ret = fortinet_generic_apply_command_delete($configuration, false);
