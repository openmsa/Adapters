...
require_once load_once('hpe_redfish', 'hpe_redfish_apply_conf.php');
//require_once load_once('hpe_redfish', 'hpe_redfish_apply_command_delete.php');
...
{
    $ret = hpe_redfish_connect($login, $passwd);
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = hpe_redfish_apply_conf($configuration, false);
...
// 	$ret = hpe_redfish_apply_command_delete($configuration, false);
