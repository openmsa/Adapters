...
require_once load_once('juniper_rest', 'juniper_rest_apply_conf.php');
//require_once load_once('juniper_rest', 'juniper_rest_apply_command_delete.php');
...
{
    $ret = juniper_rest_connect($login, $passwd);
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = juniper_rest_apply_conf($configuration, false);
...
// 	$ret = juniper_rest_apply_command_delete($configuration, false);
