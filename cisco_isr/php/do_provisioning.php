...
require_once load_once('cisco_isr', 'provisioning_stages.php');
...
unset($generated_configuration);
$ret = $conf->generate_conf($generated_configuration,'ZTD_TEMPLATE');
if ($ret !== SMS_OK)
{
	return $ret;
}
...
{
	$provisioning_stages=$ztd_provisioning_stages;
}
