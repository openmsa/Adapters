<?php
/*
 * 	Version: 0.1: faere_generic_connect.php
 *  	Created: Aug 6, 2019
...
function faere_generic_connect($sd_ip_addr = null, $login = null, $passwd = null, $adminpasswd = null, $port_to_use = null)
{
  global $sms_sd_ctx;

  try
  {
    $sms_sd_ctx = new FaereGenericsshConnection($sd_ip_addr, $login, $passwd, $adminpasswd, $port_to_use);
...
// Disconnect
// return false if error, true if ok
function faere_generic_disconnect()
{
  $sms_sd_ctx = null;
  return SMS_OK;
}

function faere_generic_synchro_prompt()
{
  global $sms_sd_ctx;
...
class FaereGenericsshConnection extends SshConnection
{
