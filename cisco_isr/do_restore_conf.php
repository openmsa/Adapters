...
require_once load_once('cisco_isr', 'cisco_isr_restore_configuration.php');
...
try
{
  ...
  $conf = new cisco_isr_restore_configuration($sdid);
  ...
  sleep(15);
  require_once load_once('cisco_isr', 'do_backup_conf.php');
