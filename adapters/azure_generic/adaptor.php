...
require_once load_once('azure_generic', 'azure_generic_apply_conf.php');
//require_once load_once('azure_generic', 'azure_generic_apply_command_delete.php');
...
{
    $ret = azure_generic_connect($login, $passwd);
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
	...
	$ret = azure_generic_apply_conf($configuration, false);
...
// 	$ret = azure_generic_apply_command_delete($configuration, false);
