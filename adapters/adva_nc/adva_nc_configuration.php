...
//require_once load_once('adva_nc', 'common.php');
require_once load_once('adva_nc', 'adva_nc_apply_conf.php');
//require_once load_once('adva_nc', 'adva_nc_apply_restore_conf.php');


require_once "$db_objects";
class adva_nc_configuration
{
...
//     return $this->running_conf;
  ...
  {
    $ret = adva_nc_apply_restore_conf($configuration);
    return $ret;
  }
  ...
  function update_conf()
  {
    ...
    {
      #$ret = adva_nc_apply_conf($generated_configuration);
