...
{
  return dogtag_pki_connect($login, $passwd);
}
...
function sd_apply_conf($configuration, $need_sd_connection = false)
{
  ...
  $ret = dogtag_pki_apply_conf($configuration, false);
...
function sd_save_conf()
{
  ...
  $conf = new dogtag_pki_configuration($sdid);
